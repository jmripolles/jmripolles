...
class MainWindow:
    ...
    def create_search_tab(self):
        ...
        source_combo = ttk.Combobox(top_frame, textvariable=self.current_source,
                                    values=["Yahoo Finance", "Investing.com"],
    ...
    def search_investing_fund(self, fund_name):
        ...
        if data:
            ...
            # Limpiar métricas ya que Investing.com no proporciona datos históricos fácilmente
            self.metrics_text.delete(1.0, tk.END)
    ...
    def plot_fund_data(self, data, symbol, ax, canvas):
        ...
        # Gráfico de velas (simplificado con línea)
    ...
    def save_plot(self):
        ...
        if filename:
            try:
                # Guardar el gráfico de la pestaña actual
