...
const LOGO = window.__resources.logoIes;
  ...
  return (
    <Sprite start={0} end={5}>
      <div style={{
        ...
        {/* grid lines */}
        <DrawLine x={120} y={200} width={1680} start={0.2} end={1.2} color={PAL.ink} height={1} />
        <DrawLine x={120} y={920} width={1680} start={0.4} end={1.4} color={PAL.ink} height={1} />

        {/* Logo, top right */}
        <Sprite start={0.3} end={4.8}>
          <Logo x={1620} y={90} size={180} />
        </Sprite>
        ...
        <Sprite start={2.0} end={4.8}>
          <TextSprite
            text="Grau Mitjà  ·  Grau Superior  ·  2000 hores  ·  titulació oficial"
  ...
  return (
    <div style={{ height: '100%', display:'flex', flexDirection:'column', justifyContent:'space-between' }}>
      ...
      <div style={{ position:'relative', flex: 1, display:'flex', alignItems:'center' }}>
        <AnimatedNumber target={target} start={start} end={end} suffix="%" size={220} color={PAL.ink} x={0} y={-20} align="left" />
      </div>
    ...
    <Sprite start={13} end={17}>
      <div style={{ position:'absolute', inset:0, background: PAL.bg }}>
        ...
        <Sprite start={14.4} end={16.9}>
          <PathPill x={120} y={760} text="Grau Mitjà — Gestió Administrativa" color={PAL.bg} bg={PAL.green} />
        </Sprite>
        <Sprite start={14.8} end={16.9}>
          <PathPill x={820} y={760} text="Grau Superior — Administració i Finances" color={PAL.bg} bg={PAL.teal} />
        </Sprite>
      </div>
    </Sprite>
  );
  ...
  return (
    <Sprite start={28} end={40}>
      <div style={{ position:'absolute', inset:0, background: PAL.ink }}>
        <div style={{ position:'absolute', inset:0, background: `radial-gradient(ellipse at 10% 100%, rgba(111,181,172,0.18), transparent 55%)` }} />
        <div style={{ position:'absolute', inset:0, background: `radial-gradient(ellipse at 90% 0%, rgba(214,168,136,0.12), transparent 55%)` }} />

        <Chrome dark />

        <Sprite start={28.1} end={39.9}>
          <TextSprite
            text="02 / Grau Superior"
            x={120} y={140} size={22} color={PAL.tealL} font={MONO} weight={700}
            letterSpacing="0.24em" entryDur={0.5} exitDur={0.3}
          />
        </Sprite>
        <Sprite start={28.3} end={39.9}>
          <TextSprite
            ...
            x={120} y={200} size={80} color={PAL.bg} font={SANS} weight={800}
            letterSpacing="-0.03em" entryDur={0.5} exitDur={0.3}
          />
        </Sprite>
        <Sprite start={28.5} end={39.9}>
          <TextSprite
            text="Administració"
            x={120} y={300} size={88} color={PAL.bg} font={SANS} weight={800}
            letterSpacing="-0.03em" entryDur={0.5} exitDur={0.3}
          />
        </Sprite>
        <Sprite start={28.7} end={39.9}>
          <TextSprite
            text="i Finances"
            x={120} y={405} size={88} color={PAL.tealL} font={SANS} weight={800}
            letterSpacing="-0.03em" entryDur={0.5} exitDur={0.3}
          />
        </Sprite>
        ...
        <Sprite start={29.4} end={39.9}>
          <StatPill x={120} y={610} label="DURADA" value="2000 h" dark />
          <StatPill x={340} y={610} label="EMPRESA" value="500 h" dark />
          <StatPill x={560} y={610} label="ERASMUS+" value="Europa" dark />
        </Sprite>

        <Sprite start={30.0} end={39.9}>
          <TextSprite
            text={"Accés a la universitat,\nal mercat laboral i a la funció\npública — inclús a l'estranger."}
            x={120} y={770} size={24} color="rgba(244,241,232,0.75)" font={SANS} weight={400}
            letterSpacing="-0.01em" entryDur={0.5} exitDur={0.3}
          />
        </Sprite>
        ...
        <Sprite start={29.8} end={39.9}>
          <TextSprite
            text="PRIMER CURS"
            x={920} y={140} size={18} color={PAL.tealL} font={MONO} weight={700}
            letterSpacing="0.22em" entryDur={0.4} exitDur={0.3}
          />
          <div style={{ position:'absolute', left:920, top:170, width:440, height:2, background:PAL.tealL }} />
          <ModuleList items={gs1} x={920} y={190} width={440} start={30.2} labelColor={PAL.tealL} dark />

          <TextSprite
            text="SEGON CURS"
            x={1420} y={140} size={18} color={PAL.tealL} font={MONO} weight={700}
            letterSpacing="0.22em" entryDur={0.4} exitDur={0.3}
          />
          <div style={{ position:'absolute', left:1420, top:170, width:440, height:2, background:PAL.tealL }} />
          <ModuleList items={gs2} x={1420} y={190} width={440} start={31.0} labelColor={PAL.tealL} dark />
        </Sprite>
      </div>
    </Sprite>
  );
    ...
    <Sprite start={54} end={62}>
      <div style={{
        ...
        <Sprite start={54.1} end={61.9}>
          <Logo x={860} y={120} size={200} />
        </Sprite>

        <Sprite start={54.7} end={61.9}>
          <TextSprite
            text="T'estem esperant."
            x={960} y={370} size={130} color={PAL.ink} font={SANS} weight={800}
        ...
        <Sprite start={55.2} end={61.9}>
          <TextSprite
            ...
            x={960} y={520} size={32} color={PAL.ink2} font={SANS} weight={400}
        ...
        <Sprite start={55.8} end={61.9}>
          <ContactBlock x={120} y={720} label="CONTACTE" lines={[
            "Camí Font de Morella, 2",
            "12.170 · Sant Mateu (Castelló)",
          ]} accent={PAL.teal} />
        </Sprite>
        <Sprite start={56.1} end={61.9}>
          <ContactBlock x={760} y={720} label="TELÈFON · CORREU" lines={[
            "964 33 60 90",
            "12004400@edu.gva.es",
          ]} accent={PAL.green} />
        </Sprite>
        <Sprite start={56.4} end={61.9}>
          <ContactBlock x={1400} y={720} label="WEB · XARXES" lines={[
