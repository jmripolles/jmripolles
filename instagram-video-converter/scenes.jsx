...
const LOGO = 'assets/logo-ies-maestrat.png';
    ...
    <Sprite start={54} end={62}>
      <div style={{
        ...
        <Sprite start={55.8} end={61.9}>
          <ContactBlock x={120} y={640} label="CONTACTE" lines={[
            "Camí Font de Morella, 2",
            "12.170 · Sant Mateu (Castelló)",
          ]} accent={PAL.teal} />
        </Sprite>
        <Sprite start={56.1} end={61.9}>
          <ContactBlock x={760} y={640} label="TELÈFON · CORREU" lines={[
            "964 33 60 90",
            "12004400@edu.gva.es",
          ]} accent={PAL.green} />
        </Sprite>
        <Sprite start={56.4} end={61.9}>
          <ContactBlock x={1400} y={640} label="WEB · XARXES" lines={[
